...
<body>
	<div class="card">
		<nav class="d-flex justify-content-between p-2 border border-primary">
			<img src="Images/cjclogo.jpeg" width="100px" height="70px">
			<div class="pt-2">
				<a href="#enroll">
									...
									<div class="row">
										...
										<div class="col">
											<select class="select form-control-sm" name="batchNumber">
												...
												<option value="FDJ-163">REG-170</option>
		...
		<section class="view" style="height: 530px" id="view">
			<h1 class="text-centre"align="center">Student Detail !!</h1>
			...
			<form name="fn" align="center" width="100%">
				...
				<tbody align="center">
					<c:forEach items="${data}" var="s">
						<tr>
							...
							<td>${s.feesPaid}</td>
							<td>
							<input type="radio" name="sid" value="${s.studentId}">
							</td>
							<td>
